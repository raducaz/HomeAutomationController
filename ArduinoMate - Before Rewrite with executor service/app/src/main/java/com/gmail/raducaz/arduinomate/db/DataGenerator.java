...
public class DataGenerator {
    ...
    public static List<ProductEntity> generateProducts() {
        ...
        List<ProductEntity> products = new ArrayList<>(1);
        ProductEntity product = new ProductEntity();
        product.setName("My Arduino Dev 1");
